...
- **VPS source path:** `/etc/dokploy/applications/app-reboot-online-alarm-rjbizi/code`
- **Public URL:** https://ddd.grooveops.dev
- **Logs:** `ssh main-instance "docker logs app-reboot-online-alarm-rjbizi"`
